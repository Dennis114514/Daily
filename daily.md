...
- 物理：探究加速度与质量的关系的实验中，无论是否有力传感器都要平衡阻力，否则最终做出的图像不过原点。有力传感器的情况下，不需要满足小车质量远大于钩码质量，因为力传感器可以直接测出绳上的拉力。

- 数学：求曲线 y=f(x) 过一定点 (a,b) 的切线的通法是b-f(x_0)=(a-x_0)·f'(x_0)，其中(x_0,f(x_0))是切点
